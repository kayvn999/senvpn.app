...
export default function Sidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
        <img src="/logo.png" alt="SEN VPN" className="w-10 h-10 rounded-xl object-cover" />
        <div>
          <p className="font-bold text-gray-900 leading-tight">SEN VPN</p>
  ...
  return (
    <>
      ...
      {/* Mobile drawer */}
      <aside
        className={`lg:hidden fixed top-0 left-0 z-50 h-full w-64 bg-white shadow-xl transition-transform duration-300 ${
